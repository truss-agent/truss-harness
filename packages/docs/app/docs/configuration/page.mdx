...
Run truss-cli setup for guided user-level configuration. It discovers reachable local endpoints and saves the selected server, model, mode, permission policy, and internet setting as the default profile.
