...
const entries = [
  {
    ...
    changes: [
      ...
      "Added persistent per-agent tool permissions to the multi-agent control center, isolated managed-agent plans from the primary chat plan, and automatically refreshes Files and Git after a managed agent changes the workspace.",
    ],
  },
  {
