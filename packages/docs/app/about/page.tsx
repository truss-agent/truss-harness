...
export const metadata = createPageMetadata({
  title: "About",
  description: `Why ${brand.productName} is building a modular coding-agent runtime that adapts to your models, tools, and workflow.`,
  path: "/about",
});
...
const principles = [
  {
    ...
    title: "Model freedom",
    description:
      "Use the local server or cloud account you already trust, then keep that choice close to the tools doing the work.",
  },
  {
    number: "02",
...
const outcomes = [
  [
    "Start where you are",
    "Connect Ollama, LM Studio, llama.cpp, another compatible local endpoint, or a supported BYOK cloud provider without adopting a hosted control plane.",
  ],
  [
    "Stay in the loop",
    ...
    <div className="site">
      ...
      <main className="site-page about-page">
        <header className="site-page-intro about-hero">
          ...
          <p>
            Truss is a modular agent runtime that keeps your models, tools,
        ...
        <section className="about-story">
          ...
          <div className="about-story-copy">
            <p>
              ...
              one hosted service. That makes the first experience simple, but it
              also makes every future choice harder.
            </p>
            <p>
              Truss starts with the runtime instead. The CLI, terminal UI, VS
              Code extension, desktop app, and future clients all use the same
              agent foundation. You can change how you work without rebuilding
              the agent around a new interface.
            </p>
          </div>
        </section>
        ...
        >
          <header className="about-section-heading">
            ...
            <p>
              Truss keeps the important choices explicit without making you
              configure the same workflow twice.
            </p>
          </header>
        ...
        <section className="about-platform">
          ...
          <ul
            className="about-system-list"
            aria-label="Replaceable Truss systems"
          >
